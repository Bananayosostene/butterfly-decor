...
export function Footer() {
  ...
  return (
    <footer className="bg-muted border-t border-border mt-4">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16 mb-8">
          {/* Brand */}
          <div className="text-center">
            <h3 className="text-lg font-bold text-primary mb-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">+250 788 724 867</p>
          </div>
